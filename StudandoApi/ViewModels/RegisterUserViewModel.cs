...
namespace SudyApi.ViewModels
{
    public class RegisterUserViewModel
    {
        ...
        [DataType(DataType.PhoneNumber, ErrorMessageResourceName = nameof(MessageClient.MC0007), ErrorMessageResourceType = typeof(MessageClient))]
        [Required(ErrorMessageResourceName = nameof(MessageClient.MC0008), ErrorMessageResourceType = typeof(MessageClient))]
        public string? PhoneNumber { get; set; }

        [Required(ErrorMessageResourceName = nameof(MessageClient.MC0009), ErrorMessageResourceType = typeof(MessageClient))]
        public int? Age { get; set; }

        [Required(ErrorMessageResourceName = nameof(MessageClient.MC0011), ErrorMessageResourceType = typeof(MessageClient))]
        [ValidationCpf(ErrorMessageResourceName = nameof(MessageClient.MC0010), ErrorMessageResourceType = typeof(MessageClient))]
        ...
        [Required(ErrorMessageResourceName = nameof(MessageClient.MC0014), ErrorMessageResourceType = typeof(MessageClient))]
        public string? Address { get; set; }

        [DataType(DataType.PostalCode, ErrorMessageResourceName = nameof(MessageClient.MC0015), ErrorMessageResourceType = typeof(MessageClient))]
        ...
        [Required(ErrorMessageResourceName = nameof(MessageClient.MC0040), ErrorMessageResourceType = typeof(MessageClient))]
